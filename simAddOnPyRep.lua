...
getPathFromCartesianPath=function(inInts,inFloats,inStrings,inBuffer)
    ...
    while i <= 1.0 do
        ...
        if #orientationCorrection > 0 then
            ...
            _rotateObject(ikTarget,orientationCorrection[1],orientationCorrection[2],orientationCorrection[3])
            -- from world frame to robot frame
            _rotateObject(ikTarget,orientationCorrection[4],orientationCorrection[5],orientationCorrection[6])
        end
