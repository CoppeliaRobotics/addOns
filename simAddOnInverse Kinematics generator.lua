...
function generate()
    ...
    appendLine("")
    appendLine("    simBase=sim.getObject('%s',{proxy=parent})",sim.getObjectAlias(getRobotBaseHandle(),1))
    appendLine("    simTip=sim.getObject('%s',{proxy=parent})",sim.getObjectAlias(getRobotTipHandle(),1))
    appendLine("    simTarget=sim.getObject('%s',{proxy=parent})",sim.getObjectAlias(getRobotTargetHandle(),1))
    appendLine("")
